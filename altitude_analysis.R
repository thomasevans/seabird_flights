...
write.csv(models.gull.fit.all, file = "gull_alt_model_fit_table_new.csv")
#
...
write.csv(models.murre.fit.all, file = "murre_alt_model_fit_table_influential_points_removed_new.csv")
#
