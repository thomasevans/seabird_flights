...
# points.df$track
# 
# plot(points.df$track_cross_wind_flt_ht~points.df$cross_wind_flt_ht)
# 
# plot(points.df$track_cross_wind_flt_ht~points.df$goal_cross_wind_flt_ht)
# plot(points.df$track_cross_wind_flt_ht~points.df$track_cross_wind_10m)
# plot(points.df$track_head_wind_flt_ht~points.df$goal_head_wind_flt_ht)
# 
# ggplot(points.df, aes(x=track_head_wind_flt_ht, y=goal_head_wind_flt_ht)) +
#   geom_point(alpha = 0.1)
# ggplot(points.df, aes(x=track_cross_wind_flt_ht, y=goal_cross_wind_flt_ht)) +
#   geom_point(alpha = 0.1)
# 
# points.df$type <- "pos"
# points.df$type[points.df$direction <0] <- "neg"
# summary(as.factor(points.df$type))
# hist(points.df$direction)
# hist((points.df$direction + 360)%%360)
# hist(points.df$direction_common)
# range(points.df$direction, na.rm = TRUE)
# points.x <- filter(points.df, track_cross_wind_flt_ht > 8 &
#                      track_cross_wind_flt_ht <9 &
#                      goal_cross_wind_flt_ht < -8 &
#                      goal_cross_wind_flt_ht > -9)

# points.df$va_u_2m[1:10]
...
df_names <- c("flight_id_combined",
              ...
              "track_cross_wind_2m_alt_filter",
              "track_head_wind_2m_alt_filter",
              "track_cross_wind_5m_alt_filter",
              "track_head_wind_5m_alt_filter",
              "track_cross_wind_flt_ht_alt_filter",
              "track_head_wind_flt_ht_alt_filter",
              "goal_cross_wind_10m_alt_filter",
              "goal_head_wind_10m_alt_filter",
              "goal_cross_wind_1m_alt_filter",
              "goal_head_wind_1m_alt_filter",
              "goal_cross_wind_2m_alt_filter",
              "goal_head_wind_2m_alt_filter",
              "goal_cross_wind_5m_alt_filter",
              "goal_head_wind_5m_alt_filter",
              "goal_cross_wind_flt_ht_alt_filter",
              "goal_head_wind_flt_ht_alt_filter",
...
for(i in 1:n_flights){
  ...
  points.flight <- filter(points.df, flight_id_combined == f_id &
                            included_points)
...
#   # points.df$tra
  ...
  # Wind variables
    ...
    flight_summary_df$va_v_2m[i] <-
      median(na.rm = TRUE, points.flight$va_v_2m[fp])  
    
    flight_summary_df$va_u_2m[i] <-
      median(na.rm = TRUE, points.flight$va_u_2m[fp])  
    
    flight_summary_df$va_v_5m[i] <-
      median(na.rm = TRUE, points.flight$va_v_5m[fp])  
    
    flight_summary_df$va_u_5m[i] <-
      median(na.rm = TRUE, points.flight$va_u_5m[fp])  
    ...
    flight_summary_df$va_2m[i] <-
      median(na.rm = TRUE, points.flight$va_2m[fp])  
    
    flight_summary_df$va_5m[i] <-
      median(na.rm = TRUE, points.flight$va_5m[fp])  
    ...
    flight_summary_df$track_cross_wind_2m[i] <-
      median(na.rm = TRUE, points.flight$track_cross_wind_2m[fp])  
    # points.flight$track
    flight_summary_df$track_head_wind_2m[i] <-
      median(na.rm = TRUE, points.flight$track_head_wind_2m[fp])  
    
    
    flight_summary_df$track_cross_wind_5m[i] <-
      median(na.rm = TRUE, points.flight$track_cross_wind_5m[fp])  
    # points.flight$track
    flight_summary_df$track_head_wind_5m[i] <-
      median(na.rm = TRUE, points.flight$track_head_wind_5m[fp])  
    ...
    # points.flight$goal
    flight_summary_df$goal_cross_wind_10m[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_10m[fp])  
    
    flight_summary_df$goal_head_wind_10m[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_10m[fp])  
    
    
    flight_summary_df$goal_cross_wind_1m[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_1m[fp])  
    # points.flight$goal
    flight_summary_df$goal_head_wind_1m[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_1m[fp])  
    
    
    flight_summary_df$goal_cross_wind_2m[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_2m[fp])  
    # points.flight$goal
    flight_summary_df$goal_head_wind_2m[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_2m[fp])  
    
    
    flight_summary_df$goal_cross_wind_5m[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_5m[fp])  
    # points.flight$goal
    flight_summary_df$goal_head_wind_5m[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_5m[fp])  
    
    flight_summary_df$goal_cross_wind_flt_ht[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_flt_ht[fp])  
    
    flight_summary_df$goal_head_wind_flt_ht[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_flt_ht[fp])                            
    ...
    flight_summary_df$va_v_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$va_v_2m[alt_incl & fp])  
    
    flight_summary_df$va_u_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$va_u_2m[alt_incl & fp])  
    
    flight_summary_df$va_v_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$va_v_5m[alt_incl & fp])  
    
    flight_summary_df$va_u_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$va_u_5m[alt_incl & fp])  
    ...
    flight_summary_df$va_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$va_2m[alt_incl & fp]) 
    
    flight_summary_df$va_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$va_5m[alt_incl & fp]) 
    ...
    flight_summary_df$track_cross_wind_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$track_cross_wind_2m[alt_incl & fp])  
    # points.flight$track
    flight_summary_df$track_head_wind_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$track_head_wind_2m[alt_incl & fp])  
    
    flight_summary_df$track_cross_wind_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$track_cross_wind_5m[alt_incl & fp])  
    # points.flight$track
    flight_summary_df$track_head_wind_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$track_head_wind_5m[alt_incl & fp])  
    ...
    # Goal
    flight_summary_df$goal_cross_wind_10m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_10m[alt_incl & fp])  
    
    flight_summary_df$goal_head_wind_10m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_10m[alt_incl & fp])      
    
    flight_summary_df$goal_cross_wind_1m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_1m[alt_incl & fp])  
    # points.flight$goal
    flight_summary_df$goal_head_wind_1m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_1m[alt_incl & fp])  
    
    flight_summary_df$goal_cross_wind_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_2m[alt_incl & fp])  
    # points.flight$goal
    flight_summary_df$goal_head_wind_2m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_2m[alt_incl & fp])  
    
    flight_summary_df$goal_cross_wind_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_5m[alt_incl & fp])  
    # points.flight$goal
    flight_summary_df$goal_head_wind_5m_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_5m[alt_incl & fp])  
    
    
    flight_summary_df$goal_cross_wind_flt_ht_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_cross_wind_flt_ht[alt_incl & fp])  
    
    flight_summary_df$goal_head_wind_flt_ht_alt_filter[i] <-
      median(na.rm = TRUE, points.flight$goal_head_wind_flt_ht[alt_incl & fp])               
    ...
    flight_summary_df$goal_dir[i] <-       deg(circ.mean(rad(points.flight$goal_dir[fp])))
    flight_summary_df$wind_angle_dif_goal[i] <-       deg(circ.mean(rad(points.flight$wind_angle_dif_goal[fp])))
#     
#     
#     "goal_dir",
#     "wind_angle_dif_goal"
