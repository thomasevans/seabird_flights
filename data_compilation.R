...
FROM lund_flights, gps_ee_track_session_limited
...
# flight over sea
# murres should all be, but gulls include quite a few from Gotland
# Need then way of labelling locations - maybe whether start location is on sea??
# Maybe can intersect (points in polygon) with the coastline map I usually use as a base map
