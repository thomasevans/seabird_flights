...
png(filename = "surface_locations_map.png",
    ...
    type = c("cairo-png"),
    width = 18, height = 6, family = "serif")


# Set global par
par(ps = 14, cex = 1.5, cex.lab = 2)
# 
# svg("surface_locations_map.svg",
#     width = 18, height = 6, family = "serif")
...
x <- c.xlim[1] + (c.xlim[2] - c.xlim[1])/20
y <- c.ylim[1] + (c.ylim[2] - c.ylim[1])/10
map.scale(ratio = FALSE, col="black",col.lab="black")
box(col="black",lwd=2)
axis(side=(1), las=1, col="black", col.axis="black")
axis(side=(2), las=1, col="black", col.axis="black")
...
png(filename = "altitude_variation_hist.png",
    units = "in",
    bg = "white", res = 600, restoreConsole = TRUE,
    type = c("cairo-png"),
...
# 
svg("altitude_variation_hist.svg",
    width = 12, height = 4, family = "serif")
...
png(filename = "altitude_precision_quantile.png",
    ...
    bg = "white", res = 600, restoreConsole = TRUE,
    type = c("cairo-png"),
    width = 12, height = 8, family = "serif")

# 
svg("altitude_precision_quantile.svg",
    width = 12, height = 8, family = "serif")
...
png(filename = "altitude_precision_sat_n_ext.png",
    ...
    bg = "white", res = 600, restoreConsole = TRUE,
    type = c("cairo-png"),
    width = 12, height = 12, family = "serif")

# 
svg("altitude_precision_sat_n_ext.svg",
    width = 12, height = 12, family = "serif")
...
png(filename = "altitude_precision_ehpe.png",
    units = "in",
    bg = "white", res = 600, restoreConsole = TRUE,
    type = c("cairo-png"),
...
# 
svg("altitude_precision_ehpe.svg",
    width = 12, height = 6, family = "serif")
...
png(filename = "altitude_precision_dop.png",
    units = "in",
    bg = "white", res = 600, restoreConsole = TRUE,
    type = c("cairo-png"),
    width = 12, height = 6, family = "serif")
...
# 
svg("altitude_precision_dop.svg",
    width = 12, height = 6, family = "serif")
...
png(filename = "altitude_precision_quantile_post_filter.png",
    units = "in",
    bg = "white", res = 600, restoreConsole = TRUE,
    type = c("cairo-png"),
    width = 12, height = 8, family = "serif")
...
# 
svg("altitude_precision_quantile_post_filter.svg",
    width = 12, height = 8, family = "serif")
